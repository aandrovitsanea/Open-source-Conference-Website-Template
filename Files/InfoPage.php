...
<!---------------------------------------- MENU BAR ------------------------------------------------------>
    ...
    <div id="main">
        ...
        <p>
        The purpose of the 1st International Conference on Web Technologies is to bring together researchers, engineers and practitioners interested in the technological advances and business applications of web-based information systems. The conference covers different aspects of Web Information Systems, namely Internet Technology, Web Interfaces and Applications, Society, e-Communities, e-Business, Web Intelligence and Mobile Information Systems. It focuses on real world applications; therefore authors should highlight the benefits of Web Information Systems and Technologies for industry and services, in addition to academic applications. Ideas on how to solve business problems using web-based information systems and technologies, will be discussed at the conference.
        </p>
    </div>
</body>
</html>
